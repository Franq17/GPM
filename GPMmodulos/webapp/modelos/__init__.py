...
from .models_adm import User, Rol, Permiso, Fase, permisoPorRol, Proyecto, Comite, rolPorUsuario, TipoItem, HistorialItem, Item, Atributo, LineaBase, HistorialLineaBase
