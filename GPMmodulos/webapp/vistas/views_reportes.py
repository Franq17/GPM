...
def itemsxproyecto():
    ...
    if form.validate_on_submit():
        ...
        my_report.generate_by(PDFGenerator, filename='/home/psanz/Escritorio/items_'+proyecto.nombre+'.pdf')
...
def historialxitemPaso2(proyecto_id):
    ...
    if form.validate_on_submit():
        ...
        my_report.generate_by(PDFGenerator, filename='/home/psanz/Escritorio/historial_'+item.nombre+'.pdf')
